  ...
  methods: {
    ...
    downloadDatabase: function downloadDatabase() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default()({
        ...
        link.href = window.URL.createObjectURL(blob); // Extracting the filename from the response headers
        ...
        console.error('Error downloading file:', error); // Handle error accordingly
      });
    }
  }
});
  ...
  methods: {
    ...
    changeLanguage: function changeLanguage(event) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(this.$apiUrl + '/change_language', data).then(function (response) {
        _this3.isLoading = false; // Check if the selected language is Arabic, and add the 'rtl' class to the body
                        ...
                        _vm.$appLogo != ""
                          ...
                          : _c("img", {
                              ...
                              attrs: {
                                src:
                                  _vm.$baseUrl +
                                  "/storage/front_end/web_logo/1761503232_92696.png",
                                alt: "Logo",
                                srcset: "",
                              },
                            }),
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "btn btn-outline-secondary btn-sm d-flex align-items-center justify-content-center p-2",
                    ...
                    [
                      ...
                      _c(
                        "div",
                        { staticClass: "form-check form-switch fs-6 d-none" },
                        [
                          _c("input", {
                            directives: [
                              {
                  ...
                  _c(
                    "button",
                    {
                      ref: "confirmButton",
                      staticClass:
                        "btn btn-outline-secondary btn-sm d-flex align-items-center justify-content-center p-2 position-relative",
                      staticStyle: { width: "40px", height: "40px" },
                      attrs: {
                        type: "button",
                        id: "confirmButton",
                  ...
                  _vm.$websiteUrl
                    ? _c(
                        ...
                        [_c("i", { staticClass: "fa fa-solid fa-globe" })]
                      )
                    : _vm._e(),
                  _vm._v(" "),
                  _vm._m(1),
                  _vm._v(" "),
                  _c("div", { staticClass: "btn-group position-relative" }, [
                    _c(
                      "button",
                      {
                        staticClass:
                      ...
                      [
                        ...
                        _vm.notifications_unread_count > 0
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "badge bg-success rounded-circle position-absolute translate-middle",
                                staticStyle: {
                                  bottom: "0px",
                                  left: "25px",
                                  "font-size": "0.6em",
                  ...
                  [
                    _c("div", { staticClass: "user-menu d-flex" }, [
                      _c("div", { staticClass: "user-name text-end me-3" }, [
                        _c(
                          "h6",
                          { staticClass: "mb-0 text-gray-600 text-capitalize" },
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "mb-0 text-sm text-gray-600 text-capitalize",
                          },
                ...
                _c(
                  ...
                  [
                    _c("li", [
                      _c(
                        "h6",
                        { staticClass: "dropdown-header text-capitalize" },
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "btn-group position-relative" }, [
      _c(
        "button",
        {
          staticClass:
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "user-img d-flex align-items-center" }, [
      _c("div", { staticClass: "avatar avatar-md22" }, [
        _c("img", { attrs: { src: "/images/user.webp", alt: "User Avatar" } }),
      ]),
    ])
  },
  function () {
