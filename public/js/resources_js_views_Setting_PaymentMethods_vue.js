    ...
    getPaymentMethods: function getPaymentMethods() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + '/payment_methods').then(function (response) {
        if (response.data.data) {
          ...
          _this.payment_method.phonepay_mode = _this.record.phonepay_mode; // this.payment_method.phonepay_api_key = this.record.phonepay_api_key;

          _this.payment_method.phonepay_merchant_id = _this.record.phonepay_merchant_id; // this.payment_method.phonepay_salt_index = this.record.phonepay_salt_index;
