  ...
  methods: {
    ...
    allSelectCheckBox: function allSelectCheckBox() {
      ...
      if (this.all_select === false) {
        this.all_select = true; // Assuming `pageSize` is the number of products to display per page
        ...
        this.selectedItems = []; // Reset the displayed products to the original list if all items are deselected
