...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    handlePanelLoginBackgroundImgUpload: function handlePanelLoginBackgroundImgUpload() {
      var file = this.$refs.panel_login_background_img.files[0]; // Reset previous error message
    ...
    saveRecord: function saveRecord() {
      ...
      for (var key in store_settingsObject) {
        var value = store_settingsObject[key]; // Encrypt google_place_api_key before sending
