<template>
    <div>
        ...
        <div class="page-content">
            <section class="row">
                <div class="row">
                    <div class="col-12 dashboard-counter">
                        <div class="row">
                                        ...
                                        <div class="card-body px-3 py-4-5">
                                            <div class="row d-flex flex-column justify-content-center ">
                                                <div class="col-md-12 d-flex justify-content-center align-items-center">
                                                    <div class="stats-icon-big" style="background-color: #fd651a;">
                                                        <img
                        ...
                        <div class="card h-95">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <apexchart width="700" height="260" :options="options"
                                        :series="series" ref="apexBarChart"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <b-col md="3">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <date-range-picker :autoApply=false :showDropdowns=true
                                                v-model="deliveryDateRange" :maxDate="maxDate"
                                                @update="getLatestOrders" :ranges="customRanges"></date-range-picker>
                                            <button class="btn btn-sm btn-danger ml-1"
                                                @click="deliveryDateRange.startDate = null, deliveryDateRange.endDate = null, getLatestOrders()">
                                                {{ __('clear') }}
                                            </button>
                                        </div>
                                    </b-col>
                                ...
                                <div class="table-responsive">
                                    <b-table :items="orders" :fields="orderFields"
                                        :current-page="orderCurrentPage" :per-page="orderPerPage"
                                        :filter="orderFilter" :filter-included-fields="filterOn"
                                        :sort-by.sync="sortBy" :sort-desc.sync="sortDesc"
                                        :sort-direction="sortDirection" :bordered="true" :busy="isLoading"
                                ...
                                <b-row>
                                    ...
                                    <b-col md="4" class="my-1" offset-md="6">
                                        <b-pagination v-model="orderCurrentPage" :total-rows="orderTotalRows"
                                            :per-page="orderPerPage" align="fill" size="sm"
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="card h-95">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <b-table :items="sellers" :fields="sellerFields"
                                        :current-page="currentPage" :per-page="perPage" :filter="sellerFilter"
                                        :filter-included-fields="filterOn" :sort-by.sync="sortBy"
                                        :sort-desc.sync="sortDesc" :sort-direction="sortDirection"
                                        :bordered="true" stacked="md" show-empty small>
                                ...
                                <b-row>
                                    ...
                                    <b-col md="4" class="my-1" offset-md="6">
                                        <b-pagination v-model="currentPage" :total-rows="totalRows"
                                            :per-page="perPage" align="fill" size="sm"
                                            class="my-0"></b-pagination>
                                    </b-col>
                                </b-row>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <b-table :items="categories" :fields="categoryFields"
                                        ...
                                        :sort-by.sync="sortBy" :sort-desc.sync="sortDesc"
                                        :sort-direction="sortDirection" :bordered="true" stacked="md"
                                        show-empty small>
                                        <template #head(total_revenue)="row">
                                            {{ __('total_revenue') + ' (' + $currency + ')' }}
                                        </template>
    ...
    export default {
        ...
        methods: {
            ...
            getThisWeekRange() {
                ...
                1); // Start of the current week (Sunday as start day)
            ...
            getLatestOrders: function() {
                ...
                let vm = this;
                let param = {
                    "startDate": (this.dateRange.startDate != null) ? moment(this.dateRange.startDate).format(
                        'YYYY-MM-DD') : "",
                    "endDate": (this.dateRange.endDate != null) ? moment(this.dateRange.endDate).format(
                        'YYYY-MM-DD') : "",
                    "seller": this.seller,
                    "status": this.status,
                    startDeliveryDate: this.deliveryDateRange.startDate ? moment(this.deliveryDateRange
                        .startDate).format('YYYY-MM-DD') : '',
                    endDeliveryDate: this.deliveryDateRange.endDate ? moment(this.deliveryDateRange.endDate)
                        .format('YYYY-MM-DD') : '',
                }
