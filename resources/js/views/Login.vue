...
<div class="auth-logo" style="text-align: center;">
  <a href="javascript:void(0)" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
    <img 
      v-if="$appLogo != ''" 
      :src="$storageUrl + $appLogo" 
      style="height: 70px; width: 160px; border-radius: 5px;" 
      alt="Logo"
    />
    <img 
      v-else 
      ...
      alt="Logo"
    />
    <h2 style="margin-top: 10px; font-size: 20px;">{{ $appName }}</h2>
  </a>
</div>
